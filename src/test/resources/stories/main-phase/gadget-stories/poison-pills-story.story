...
CONFIG_INJECT next-proposal saphira "Schleim B. Olzen,Hans Peter Otto,Austauschbarer Agent Dieter 42,magnetic_watch,poison_pills,grapple"
...
CONFIG_INJECT next-proposal saphira "Meister Yoda,Zackiger Zacharias,Misses Y,moledie,magnetic_watch,chicken_feed"
CONFIG_INJECT next-proposal dieter "Spröder Senf,Tante Gertrude,Ein Wischmob,fog_tin,hairdryer,mirror_of_wilderness"
CONFIG_INJECT next-proposal saphira "Petterson,Misses Y,Hans Peter Otto,laser_compact,jetpack,moledie"
...
CONFIG_INJECT next-proposal dieter laser_compact,hairdryer,moledie
...
CONFIG_INJECT npc-pick value "Petterson,MOLEDIE,James Bond,WIRETAP_WITH_EARPLUGS,MOTHBALL_POUCH,JETPACK,POCKET_LITTER,BOWLER_BLADE"
CONFIG_INJECT start-positions value "<cat>,4/3,Hans Peter Otto,3/2,Austauschbarer Agent Dieter 42,2/2,Petterson,4/10,Schleim B. Olzen,3/5,Mister X,1/5,Ein Wischmob,1/11,James Bond,5/11,Spröder Senf,5/3,Saphira,6/3"
CONFIG_INJECT next-round-order value "Hans Peter Otto,Austauschbarer Agent Dieter 42,Saphira,<cat>,Petterson,Ein Wischmob,James Bond,Spröder Senf,Schleim B. Olzen,Mister X"
# ------------------------------------------------------
...
EQUIP saphira "Hans Peter Otto,POISON_PILLS,TECHNICOLOUR_PRISM,MAGNETIC_WATCH,Schleim B. Olzen,GRAPPLE,Saphira,FOG_TIN"
