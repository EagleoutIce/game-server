...
CONFIG_INJECT npc-pick value "Petterson,POISON_PILLS,James Bond,WIRETAP_WITH_EARPLUGS,ROCKET_PEN,JETPACK,POCKET_LITTER,BOWLER_BLADE"
CONFIG_INJECT start-positions value "<cat>,4/3,Hans Peter Otto,2/7,Austauschbarer Agent Dieter 42,2/2,Petterson,4/2,Schleim B. Olzen,3/8,Mister X,1/9,Ein Wischmob,5/1,James Bond,5/11,Spröder Senf,5/3,Saphira,6/3"
CONFIG_INJECT next-round-order value "Austauschbarer Agent Dieter 42,Ein Wischmob,Hans Peter Otto,Saphira,<cat>,Petterson,James Bond,Spröder Senf,Schleim B. Olzen,Mister X"
# ------------------------------------------------------
...
EQUIP dieter "Mister X,Austauschbarer Agent Dieter 42,NUGGET,GAS_GLOSS,MOTHBALL_POUCH,Ein Wischmob,LASER_COMPACT,Spröder Senf"
# End of File
